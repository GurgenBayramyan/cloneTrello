...
const ModalBlock = ({taskName,listName}:IModal) => {
    const [valueInput,setValueInput] = useState(taskName);
          ...
          <div className={style.modallDescription}>
            ...
            {state.taskDesc ? (
              <div className={style.modalTaskDesc}>
                <div onClick={handleOpenChange} className={style.descrptionDiv}>
          ...
          <div className={style.commentUser}>
            ...
            {state.comment ? (
              ...
              <div className={style.inputForComment}>
                    <textarea  autoFocus={true} onBlur={handleBlurComment} placeholder='Write a  your comment'></textarea>
                    <button >Save</button>
              </div>
            )}
          </div>
